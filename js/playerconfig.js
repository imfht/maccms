...
var maccmsplay=1;  //播放器版本2普通版本,3美化版本
var popenW=704;    //弹窗窗口宽度
var popenH=566;    //弹窗窗口高度
var autoFull=0;    //是否自动全屏,0否,1是
var showlist=0;    //美化版播放器是否显示列表
var loadads="http://union.maccms.net/html/loading7.html";   //预加载广告地址
var loadpau="http://union.maccms.net/html/loadpause.html";   //缓冲广告地址
